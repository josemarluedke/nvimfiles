...
-- scroll up hover doc
map('n', '<Up>', "<cmd>lua require('lspsaga.action').smart_scroll_with_saga(-1)<CR>", opts)

-- Telescope
map('n', '<Leader>f', '<cmd>Telescope find_files find_command=rg,--ignore,--hidden,--files,--glob=!.git<CR>', opts)
map('n', '<Leader>g', '<cmd>Telescope live_grep<CR>', opts)
map('n', 't', '<cmd>Telescope find_files find_command=rg,--ignore,--hidden,--files,--glob=!.git<CR>', opts)
